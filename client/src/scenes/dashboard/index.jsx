...
import { Email, DownloadOutlined, PointOfSale, PersonAdd, Traffic } from '@mui/icons-material';
  ...
  return (
    <Box m="1.5rem 2.5rem">
      ...
      >
        ...
        >
          <OverviewChart view="sales" isDashboards={true}></OverviewChart>
        </Box>
        <StatBox 
          title="Watch monthly" 
